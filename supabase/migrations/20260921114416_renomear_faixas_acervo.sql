-- Renomeia as duas últimas faixas do painel de acervo da CJ e do CREG.
-- Só os rótulos mudam; os intervalos de dias são os mesmos.
--   7 (366 a 730 dias):  "Há mais de 1 ano" -> "Entre 1 e 2 anos"
--   8 (731 dias ou mais): "Há 2 anos"        -> "Há mais de 2 anos"
